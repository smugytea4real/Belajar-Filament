...
<body>
  <div class="bg-[url('https://cdn.pixabay.com/photo/2016/11/14/03/16/book-1822474_1280.jpg')] bg-center bg-cover h-screen">
        <div class='md:flex md:justify-between py-4 px-10'>
            ...
            <ul id="navbar" class='md:flex md:items-center z-[10] absolute md:z-auto md:static w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500 bg-slate-200 md:bg-transparent md:text-white'>
                ...
                <li class="hover:bg-slate-400 w-26 py-2 px-2 mx-2 rounded-full duration-500"><a href="#register">Register</a></li>
            </ul>
       </div>
  ...
  <div class="flex items-center justify-center h-screen bg-gray-300" id="register">
    <div class="bg-white p-8 rounded shadow-lg shadow-lg w-1/2 mt-20">
